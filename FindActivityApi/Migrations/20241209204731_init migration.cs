        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatitudeX = table.Column<double>(type: "double precision", nullable: true),
                    LongitudeY = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Evnts", x => x.EvntId);
                    table.ForeignKey(
                        name: "FK_Evnts_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "ActivityId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Evnts_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evnts_ActivityId",
                table: "Evnts",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_Evnts_UserId",
                table: "Evnts",
                column: "UserId");
